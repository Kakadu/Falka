...
(* This file was autogenerated by Falka at 5/27/2012 12:08:59 AM
 * Base parser class: InnerParser
 * Start rule in grammar: SqlExpression, in FsYacc: yard_start_1
 * Token type is Test3.Lexer.token
 *)
